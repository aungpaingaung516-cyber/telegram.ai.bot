...
# ---------------------------------------------------------
# 5. Hugging Face Music Generation (Raw Post Method)
# ---------------------------------------------------------
def query_hf_musicgen(prompt_text: str) -> bytes:
    # post method သုံးခြင်းဖြင့် model ထံမှ audio binary data ကို တိုက်ရိုက်ရယူပါသည်
    audio_bytes = hf_client.post(
